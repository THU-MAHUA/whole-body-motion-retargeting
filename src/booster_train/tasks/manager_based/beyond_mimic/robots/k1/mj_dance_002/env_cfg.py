...
class FlatEnvCfg(TrackingEnvCfg):
    def __post_init__(self):
        ...
        # Shared base; concrete MOS/K1 task configurations override this reference.
        self.commands.motion.motion_file = f"{BOOSTER_ASSETS_DIR}/motions/K1/dance_8_clip1.npz"
